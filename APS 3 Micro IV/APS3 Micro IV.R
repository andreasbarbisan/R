...
#' 
## ----descriptive_stats, echo=TRUE, message=FALSE, warning=FALSE--------------------------------------------------
star_data = star_data |> 
  mutate(
...
#' 
## ----regression_model, echo=TRUE, message=FALSE, warning=FALSE---------------------------------------------------
...
#' 
## ----fixed_effects, echo=TRUE, message=FALSE, warning=FALSE------------------------------------------------------
...
#' 
## ----randomization_check, echo=TRUE, message=FALSE, warning=FALSE------------------------------------------------
